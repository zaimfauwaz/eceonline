            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-primary text-white text-left d-flex align-items-center justify-content-start">
                            <i class="@yield('form_icon') @yield('form_icon_color') fa-2x me-3"></i>
                            <div>
                                <h4 class="mb-0">@yield('form_title')</h4>
                                <p class="mb-0">@yield('form_description')</p>
                            </div>
                        </div>
                        <div class="card-body">
                            @yield('content')
